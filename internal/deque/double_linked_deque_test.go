...
func TestDoubleLinkedDeque_Front(t *testing.T) {
...
func TestDoubleLinkedDeque_Back(t *testing.T) {
	t.Run("Empty", func(t *testing.T) {
		deque := NewDoubleLinkedDeque[int]()
...
func TestDoubleLinkedDeque_Pop(t *testing.T) {
	t.Run("Empty", func(t *testing.T) {
		deque := NewDoubleLinkedDeque[int]()
...
func TestDoubleLinkedDeque_ToSlice(t *testing.T) {
	t.Run("Empty", func(t *testing.T) {
		deque := NewDoubleLinkedDeque[int]()
...
func TestDoubleLinkedDeque_MarshalJSON(t *testing.T) {
	t.Run("Empty", func(t *testing.T) {
		deque := NewDoubleLinkedDeque[int]()
